...
- TLS terminates at the gateway. Internal traffic runs on an isolated network. Connections
  to Postgres and MinIO use TLS with certificates issued by OpenBao PKI.
